...
int main() {
    ...
    string rutaArchivoSalida = "C:\\Users\\Public\\Documents\\@UNAM-III CICLO 2024\\@HONORIO_ANALISIS ALG\\c++_times\\selection_times.txt";
    ...
    for (const string& size : fileSizes) {
        ...
        if (!datos.empty()) { 
            ...
            double tiempo = medirTiempo(selectionSort, datosCopia, "Selection Sort para File_" + size);
